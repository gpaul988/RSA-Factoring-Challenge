...
/**
 * @brief Assembling RSA REF recipient
 *
 */
class RSARef
{
public:
	/**
	 * @brief Assembke fresh Rsa Ref recipient
	 *
	 * @param line Number of strings
	 */
...
public:
	/**
	 * @brief Assemble fresh  Rsa Prime recipients
	 *
	 * @param line Number of strings
	 */
